...
See the provided shell scripts. The build output will be stored in `./build/VST3/homecorrupter.vst3` as well as symbolically linked to your systems VST-plugin folder (on Unix).
